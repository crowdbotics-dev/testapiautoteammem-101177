...
## Project Structure
    ...
    ├── testapiautoteammem_101177  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_101177`
...
2. Clone this repo and `cd testapiautoteammem_101177`
